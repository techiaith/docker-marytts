...
def record_session(recordings_dir):
    ...
    #festvox_donefile = io.open(os.path.join(recordings_dir, 'txt.done.data'), 'w', encoding='utf-8')
    ...
    while not done:
        ...
        for event in pygame.event.get():
            ...
            if event.type == pygame.KEYDOWN and \
                ...
                current_wav_file = os.path.join(recordings_dir,fname + '.wav')                
            ...
            recording is True:
                ...
                if not rerecord:
                    ...
                    f = open(current_wav_file.replace(".wav",".txt"), 'w', encoding='utf-8')
                    f.write(outstanding_prompts[current_prompt_idx]["text"])
                    f.close()
...
def display_help:
    print ("python3 RecordPrompts-GUI.py -d <directory for audio and recorded prompts>")
